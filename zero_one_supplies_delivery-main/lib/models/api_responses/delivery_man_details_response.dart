...
class DeliveryManDetailsResponse {
  bool error;
  String msg;
  ...
  factory DeliveryManDetailsResponse.fromJson(Map<String, dynamic> json) {
    return DeliveryManDetailsResponse(
  ...
  factory DeliveryManDetailsResponse.empty() =>
      DeliveryManDetailsResponse(data: DeliveryManDataResponse.empty());

  static DeliveryManDetailsResponse getAPIResponseObjectSafeValue(
          dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? DeliveryManDetailsResponse.fromJson(
              unsafeResponseValue as Map<String, dynamic>)
          : DeliveryManDetailsResponse.empty();
}
