...
class SiteSettings {
  ...
  List<SiteSettingsWithdrawMethodResponse> withdrawMethods;
  String otpOption;
  ...
  factory SiteSettings.fromJson(Map<String, dynamic> json) => SiteSettings(
        ...
        pickupArea: APIHelper.getSafeListValue(json['pickup_area'])
            ...
            .toList(),
        withdrawMethods: APIHelper.getSafeListValue(json['withdraw_methods'])
            .map((e) => SiteSettingsWithdrawMethodResponse
  ...
  Map<String, dynamic> toJson() => {
        ...
        'withdraw_methods': withdrawMethods.map((e) => e.toJson()).toList(),
      };
...
class SiteSettingsWithdrawMethodResponse {
  String name;
  String logo;
  String id;

  SiteSettingsWithdrawMethodResponse(
      {this.name = '', this.logo = '', this.id = ''});

  factory SiteSettingsWithdrawMethodResponse.fromJson(
      Map<String, dynamic> json) {
    return SiteSettingsWithdrawMethodResponse(
      name: APIHelper.getSafeStringValue(json['name']),
      logo: APIHelper.getSafeStringValue(json['logo']),
      id: APIHelper.getSafeStringValue(json['_id']),
    );
  ...
  static SiteSettingsWithdrawMethodResponse getAPIResponseObjectSafeValue(
          dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? SiteSettingsWithdrawMethodResponse.fromJson(
              unsafeResponseValue as Map<String, dynamic>)
          : SiteSettingsWithdrawMethodResponse();
}
