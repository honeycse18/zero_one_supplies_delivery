import 'package:ecomikdeliveryapp/controller/bottom_sheets/file_details.dart';
...
class FileDetailsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleRightSideWidget = TightIconButtonWidget(
        ...
        icon: Image.asset(AppAssetImages.walletSvgLogo));
